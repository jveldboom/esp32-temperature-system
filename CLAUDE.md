...
- Tags each reading with `reset_reason` (raw `esp_reset_reason()` int): 1=power_on, 2=external, 3=software, 4=panic, 5=watchdog_int, 6=watchdog_task, 7=watchdog, 8=deep_sleep, 9=brownout, 10=sdio
